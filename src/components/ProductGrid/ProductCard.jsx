  ...
  return (
    <div className="p-5">
      ...
      >
        <Link
          to={`product/${name}`}
          className="z-30 absolute inset-0 opacity-0 group-hover:opacity-100 bg-black bg-opacity-50 transition-opacity duration-200 flex justify-center items-center flex-col text-center gap-5"
        >
          <p className="text-white">{description}</p>
          <button className="py-2 px-5 rounded-lg bg-blue-500 text-white flex items-center gap-1 text-sm">
            <MdAddShoppingCart />
